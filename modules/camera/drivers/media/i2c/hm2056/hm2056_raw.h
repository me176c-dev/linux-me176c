...
#define HM2056B_NAME				"hm2056b"
#define HM2056F_NAME				"hm2056f"
...
/* Focal length*/
#define HM2056_FOCAL_LENGTH_NUM 0x125		/*2.93mm*/
#define HM2056_FOCAL_LENGTH_DEM 0x64
#define HM2056_FOCAL_LENGTH_DEFAULT 0x01250064
...
static const struct i2c_device_id hm2056b_raw_id[] = {
	{HM2056B_NAME, 0},
	{}
};
static const struct i2c_device_id hm2056f_raw_id[] = {
	{HM2056F_NAME, 0},
	{}
};
 ...
 * initial settings
 */
static struct hm2056_reg const hm2056_init_flip[] = {
	{HM2056_8BIT, 0x0022, 0x00},	// Reset
	{HM2056_8BIT, 0x0020, 0x00},
	{HM2056_8BIT, 0x0025, 0x00},	//CKCFG 80 from system clock, 00 from PLL
	{HM2056_8BIT, 0x0026, 0x85},	//PLL1CFG should be 07 when system clock, should be 87 when PLL
	...
	{HM2056_8BIT, 0x002C, 0x0A},	//Set default vaule for CP and resistance of LPF to 1010
	{HM2056_8BIT, 0x0004, 0x10},
	{HM2056_8BIT, 0x0006, 0x01},	// Flip/Mirror
	{HM2056_8BIT, 0x000D, 0x00},	// 20120220 to fix morie
	{HM2056_8BIT, 0x000E, 0x00},	// Binning ON
	{HM2056_8BIT, 0x000F, 0x00},	// IMGCFG
	{HM2056_8BIT, 0x0010, 0x00},	// VBI - 20131106
...
static struct hm2056_reg const hm2056_uxga_14fps_flip[] = {
	{HM2056_8BIT, 0x0024, 0x00},
	{HM2056_8BIT, 0x0006, 0x01},
	{HM2056_8BIT, 0x000D, 0x00},
	{HM2056_8BIT, 0x000E, 0x00},
	{HM2056_8BIT, 0x0010, 0x00},
	{HM2056_8BIT, 0x0011, 0x8A},
...
//1620x912
static struct hm2056_reg const hm2056_hdp_19fps_flip[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x15},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x00},
    {HM2056_8BIT, 0x0011, 0x64},
...
//1392x780
static struct hm2056_reg const hm2056_1392x780_28fps_flip[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x11},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x00},
    {HM2056_8BIT, 0x0011, 0x84},
...
//1296x812
static struct hm2056_reg const hm2056_1296x812_28fps_flip[] = {
    {HM2056_8BIT, 0x0024, 0x00},
    {HM2056_8BIT, 0x0006, 0x05},
    {HM2056_8BIT, 0x000D, 0x00},
    {HM2056_8BIT, 0x000E, 0x00},
    {HM2056_8BIT, 0x0010, 0x00},
    {HM2056_8BIT, 0x0011, 0x8d},
 ...
 * 1296x732
 */
static struct hm2056_reg const hm2056_720p_27fps_flip[] = {
	{HM2056_8BIT, 0x0024, 0x00},
	{HM2056_8BIT, 0x0006, 0x09},	// Flip/Mirror
	{HM2056_8BIT, 0x000D, 0x00},	// 20120220 to fix morie
	{HM2056_8BIT, 0x000E, 0x00},	// Binning ON
	{HM2056_8BIT, 0x0010, 0x00},
	{HM2056_8BIT, 0x0011, 0x8E},
 ...
 * 810 x 626
 */
static struct hm2056_reg const hm2056_svga_30fps_flip[] = {	
	{HM2056_8BIT, 0x0024, 0x00},
	{HM2056_8BIT, 0x0006, 0x01},	// Flip/Mirror
	{HM2056_8BIT, 0x000D, 0x11},	// 20120220 to fix morie
	{HM2056_8BIT, 0x000E, 0x11},	// Binning ON
 ...
 * Please, keep them in ascending order.
 */
static struct hm2056_raw_res_struct hm2056_raw_res_still_flip[] = {
    {
    .desc	= "HDP",
    .width	= 1620,
    .height	= 912,
...
#define N_RES_STILL_FLIP (ARRAY_SIZE(hm2056_raw_res_still_flip))

static struct hm2056_raw_res_struct hm2056_raw_res_video_flip[] = {
	{
	.desc	= "SVGA",
	.width	= 812,
	.height	= 626,
	...
	//.fps	= 28,
	//.used	= 0,
	//.regs	= "hm2056_1296x812_28fps_flip",
	//.skip_frames = 1,
	//.horizontal_start = 0,
	//.horizontal_end = 1295,
	//.vertical_start = 0,
	...
	.fps	= 28,
	.used	= 0,
	.regs	= "hm2056_1392x780_28fps_flip",
	.skip_frames = 1,
	.horizontal_start = 0,
	.horizontal_end = 1391,
	.vertical_start = 0,
...
#define N_RES_VIDEO_FLIP (ARRAY_SIZE(hm2056_raw_res_video_flip))
